...
import { createMovieValidator, getMovieValidator, movieValidator, updateMovieValidator } from "../../validations/MovieValidator";
...
export class MovieRoutes extends BaseRoutes {
  ...
  public routes(): void {
    ...
    this.router.put('/:id', validate(updateMovieValidator), validate(getMovieValidator), this._movieController.update);
